...
integer \var{type} argument and returns the Sybase result code.  The Sybase
\function{ct_cancel()} function is called like this:
...
\var{server} argument and returns the Sybase result code.  The Sybase
